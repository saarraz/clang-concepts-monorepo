...
// expected-error@-1{{parentheses are required around initialization expression in this context}}
struct B4 { };

template<typename T> requires sizeof(T) == 0
// expected-error@-1{{parentheses are required around sizeof expression in this context}}
struct B5 { };
